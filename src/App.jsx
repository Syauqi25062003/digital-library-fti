...
export default function App() {
  ...
  return (
    <Router>
      <Navbar onLoginOpen={() => setLoginOpen(true)} onRegisterOpen={() => setRegisterOpen(true)} />
      ...
      <div className="pt-24 min-h-[80vh]">
        <Routes>
          ...
          <Route
            ...
            element={<MahasiswaLayout><MahasiswaDashboard /></MahasiswaLayout>}
          />
          <Route
            path="/mahasiswa/upload"
            element={<MahasiswaLayout><UploadLaporan /></MahasiswaLayout>}
          />
          <Route
            path="/mahasiswa/status"
            element={<MahasiswaLayout><Status /></MahasiswaLayout>}
          />
          <Route
            path="/mahasiswa/profil"
            element={<MahasiswaLayout><ProfilMahasiswa /></MahasiswaLayout>}
          />
          <Route
            path="/mahasiswa/pengaturan"
            element={<MahasiswaLayout><Pengaturan /></MahasiswaLayout>}
          />
          ...
          <Route
            path="/admin/review"
            element={<AdminLayout><ReviewLaporan /></AdminLayout>}
          />
          <Route
            path="/admin/upload"
            element={<AdminLayout><UploadManual /></AdminLayout>}
          />
          <Route
            path="/admin/arsip"
            element={<AdminLayout><KelolaArsip /></AdminLayout>}
          />
          <Route
            path="/admin/akun"
            element={<AdminLayout><KelolaAkun /></AdminLayout>}
          />
          <Route
            path="/admin/profil"
            element={<AdminLayout><ProfilAdmin /></AdminLayout>}
          />
          <Route
            path="/admin/pengaturan"
            element={<AdminLayout><Profilpengaturan /></AdminLayout>}
          />
        </Routes>
      </div>
